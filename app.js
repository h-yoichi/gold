...
const resultContent = {
  ...
  high: {
    ...
    title: "ご家族にバレるリスク：高め",
    body: [
      "返済のために新しく借入をしていたり、督促・通知・明細などを気にしながら生活している状態で、精神的なストレスが大きいものと思われます。",
      "郵便物・スマホ通知・突然の電話などをきっかけに、ご家族に知られてしまう可能性があります。",
      "ただし、今すぐご家族に話さなければいけない状況とは限りません。弁護士に相談すると、家族に知られにくい連絡方法や、月々の返済を見直す方法を確認できる場合があります。",
    ],
    ctaLead: "一人で抱え込む前に、まずは「家族にバレない進め方」だけ確認してみてください。",
    ctaText: "今すぐ無料で相談する",
  },
};
